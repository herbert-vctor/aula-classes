...
[<img src="./aula-classes.gif" alt="gif da aula sobre classes do módulo básico de CSS">](https://www.youtube.com/@DevemDobro)
...
## Como utilizar
### 1- Clone o projeto
- git clone <https://github.com/herbert-vctor/aula-classes.git>
...
## O que aprendi ?
Como o próprio nome do repositório já diz, eu aprendi sobre a utilização das classes no HTML e como estiliza-las no CSS.
